    ...
    <div>
      ...
      <div className="relative h-screen w-full bg-cover bg-center">
        ...
        <div className="flex flex-col items-center justify-center h-full text-center px-4 z-20">
          <h1 className="text-white text-4xl md:text-5xl lg:text-4xl font-bold mb-4  z-10">ADVANCED TEA PLANTATION MONITORING SYSTEM <br/>USING MULTISPECTRAL DRONE IMAGERY AND IOT</h1>
          <p className="text-white text-lg md:text-xl lg:text-2xl max-w-2xl mx-auto  z-10 text-justify">"AgriVision offers an all-in-one solution for plantation owners and managers, 
            combining advanced drone imaging, IoT data, and AI-driven insights. Optimize your resources, increase productivity, and boost profitability with real-time field analytics
             tailored for precision agriculture. Empower your business with AgriVision's cutting-edge technology to stay ahead in the competitive agricultural industry."</p>
        </div>
